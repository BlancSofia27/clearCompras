...
const Profile: React.FC = () => {
  ...
  console.log('User Data:', user); // Log de los datos del usuario
      ...
      <div className="relative w-full h-[400px]">
        ...
        <div className="absolute inset-0 flex justify-start items-center ">
          <img
            ...
            style={{ marginTop: 'calc(16% - 2rem)' }} // Adjust to ensure the logo is positioned in the middle
          />
        </div>
      </div>
      {/* User Information */}
      <div className="p-4 mt-8">
        <h1 className="text-3xl font-bold my-2">{user.businessName}</h1>
  ...
  className="flex items-center  w-1/10 mx-2 rounded bg-[#c13584] px-6 py-2.5 md:px-5 text-xs font-medium uppercase leading-normal text-white focus:outline-none transition duration-1000 ease-in-out transform hover:bg-white hover:text-[#c13584]"
>
  <svg
    className="h-4 w-4 mr-1"
    xmlns="http://www.w3.org/2000/svg"
  ...
  <span className="hidden xl:block lg:block md:block">Instagram</span>
</a>
</div>
      </div>
    </div>
